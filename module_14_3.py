...
async def get_buying_list(messge):
    for i in range(1,5):
        with open(f'pictures/pic{i}.png', "rb") as img:
            await messge.answer_photo(img, f"Название: Product{i} | Описание: описание{i} | Цена: {i*100}")
    await messge.answer("Выбирите продукт для покупки", reply_markup=kb_in_buy)
